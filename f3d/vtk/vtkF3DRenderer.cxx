...
void vtkF3DRenderer::ReleaseGraphicsResources(vtkWindow* w)
{
  ...
  // b this->UIActor->ReleaseGraphicsResources(w);
...
void vtkF3DRenderer::Initialize()
{
  ...
  // b this->UIActor->Initialize(vtkOpenGLRenderWindow::SafeDownCast(this->RenderWindow));
}
...
void vtkF3DRenderer::ConfigureTextActors()
{
  ...
  if (!fontFileStr.empty())
  {
    ...
    {
      // b this->UIActor->SetFontFile(fontFileStr);
    }
    else
    {
      F3DLog::Print(
  ...
  // b this->UIActor->SetFontScale(this->FontScale);
...
{
  // b this->UIActor->SetFileName(info);
}

//----------------------------------------------------------------------------
void vtkF3DRenderer::SetDropZoneInfo(const std::string& info)
{
  // b this->UIActor->SetDropText(info);
}
...
void vtkF3DRenderer::ShowTimer(bool show)
{
  if (this->TimerVisible != show)
  {
    ...
    // b this->UIActor->SetFpsCounterVisibility(show);
    this->CheatSheetConfigured = false;
  }
}
...
void vtkF3DRenderer::ShowFilename(bool show)
{
  if (this->FilenameVisible != show)
  {
    ...
    // b this->UIActor->SetFileNameVisibility(show);
    this->CheatSheetConfigured = false;
  }
}
...
void vtkF3DRenderer::ShowMetaData(bool show)
{
  if (this->MetaDataVisible != show)
  {
    ...
    // b this->UIActor->SetMetaDataVisibility(show);
    this->MetaDataConfigured = false;
    this->CheatSheetConfigured = false;
  }
}
...
{
  // b this->UIActor->SetMetaDataVisibility(this->MetaDataVisible);
  if (this->MetaDataVisible)
  {
    assert(this->Importer);
    // b this->UIActor->SetMetaData(this->Importer->GetMetaDataDescription());
  }
...
void vtkF3DRenderer::ShowCheatSheet(bool show)
{
  if (this->CheatSheetVisible != show)
  {
    ...
    // b this->UIActor->SetCheatSheetVisibility(show);
    this->CheatSheetConfigured = false;
  }
}
...
void vtkF3DRenderer::ShowConsole(bool show)
{
  if (this->ConsoleVisible != show)
  {
    ...
    // b this->UIActor->SetConsoleVisibility(show);
    this->CheatSheetConfigured = false;
  }
}
...
void vtkF3DRenderer::ShowMinimalConsole(bool show)
{
  if (this->MinimalConsoleVisible != show)
  {
    ...
    // b this->UIActor->SetMinimalConsoleVisibility(show);
    this->CheatSheetConfigured = false;
  }
}
...
void vtkF3DRenderer::ShowDropZone(bool show)
{
  if (this->DropZoneVisible != show)
  {
    ...
    // b this->UIActor->SetDropZoneVisibility(show);
  }
}
...
void vtkF3DRenderer::Render()
{
  ...
  if (!uiOnly)
  {
    ...
    // b this->UIActor->UpdateFpsValue(elapsedTime);
  }
}
...
{
  // b this->UIActor->SetDeltaTime(time);
}

//----------------------------------------------------------------------------
void vtkF3DRenderer::SetConsoleBadgeEnabled(bool enabled)
{
  // b this->UIActor->SetConsoleBadgeEnabled(enabled);
}
