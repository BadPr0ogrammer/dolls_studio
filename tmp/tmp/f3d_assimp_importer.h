...
#ifndef f3d_assimp_importer_h
#define f3d_assimp_importer_h
...
class f3d_assimp_importer : public vtkImporter
{
public:
  static f3d_assimp_importer* New();
  vtkTypeMacro(f3d_assimp_importer, vtkImporter);
...
private:
  f3d_assimp_importer(const f3d_assimp_importer&) = delete;
  void operator=(const f3d_assimp_importer&) = delete;
