...
bool vtkF3DAssimpImporter::UpdateAtTimeValue(double timeValue)
{
  ...
  */
  aiAnimation* anim = this->Internals->Scene->mAnimations[0];
  /*
  ...
  {
  */
    aiNodeAnim* nodeAnim = anim->mChannels[0];//anim->mChannels[nodeChannelId];
    ...
    */
    aiVectorKey* positionKey = nodeAnim->mPositionKeys + currentIdx;
